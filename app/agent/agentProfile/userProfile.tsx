                    ...
                    <View>
                        ...
                        <View className="px-3 py-3 flex flex-col gap-1 mt-5">
                            ...
                            <View className="w-full">
                                <Text className="text-base mb-1 text-white">First Name:</Text>

                                <TextInput
                                    className="border border-[#0415FE1F] bg-[#0415FE] w-full py-5 px-4 text-lg rounded-md text-white"
                            ...
                            {/*  */}
                            <View className="w-full">
                                <Text className="text-base mb-1 text-white">Last Name:</Text>
                            ...
                            {/*  */}
                            <View className="w-full">
                                <Text className="text-base mb-1 text-white">Location:</Text>
                                <TextInput
                                    className="border border-[#0415FE1F] bg-[#0415FE] w-full py-5 px-4 text-lg rounded-md text-white"
                            ...
                            <View className="w-full">
                                <Text className="text-base mb-1 text-white">Date of Birth:</Text>
                                <TouchableOpacity
                                    className="border border-[#0415FE1F] bg-[#0415FE] w-full py-5 px-4 text-lg rounded-md text-white"
                                    activeOpacity={0.7}
                                    onPress={() => {
                            ...
                            <View style={{ zIndex: 1000 }}>
                                <Text className="text-base mb-1 text-white">Gender:</Text>
                                <DropDownPicker
                                    open={open}
                                    setOpen={setOpen}
                                    value={values.gender}
                            ...
                            <View style={{ marginTop: 20, zIndex: 1, flexDirection: "column", gap: 4 }}>
