    ...
    return (
        <>
            <TouchableOpacity
                ...
                className={`${className} w-full items-center py-6 p-4 border border-[#0415FE] border-dashed rounded-lg bg-[#010540FC] mb-2`}
            >
...
export default AgentFileDropzone;
